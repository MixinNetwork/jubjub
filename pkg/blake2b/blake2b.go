...
func New512(key []byte) (hash.Hash, error) { return newDigest(Size, key, nil) }
func New512WithPersonalization(key, personalization []byte) (hash.Hash, error) {
	return newDigest(Size, key, personalization)
}

// New384 returns a new hash.Hash computing the BLAKE2b-384 checksum. A non-nil
// key turns the hash into a MAC. The key must be between zero and 64 bytes long.
func New384(key []byte) (hash.Hash, error) { return newDigest(Size384, key, nil) }
